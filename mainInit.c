...
extern void pa1_iterateInit( Abc_Frame_t *pAbc ); ///// pa1 iterate
extern void pa1_andtreeInit( Abc_Frame_t *pAbc ); ///// pa1 andtree
...
void Abc_FrameInit( Abc_Frame_t * pAbc )
{
    ...
    Pla_Init( pAbc );
    Test_Init( pAbc );
    pa1_iterateInit( pAbc ); ///// pa1 iterate
    pa1_andtreeInit( pAbc ); ///// pa1 andtree
    Glucose_Init( pAbc );
    Glucose2_Init( pAbc );
